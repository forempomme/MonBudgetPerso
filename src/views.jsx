                    ...
                    {isConf ? (
                      ...
                      <div style={{ display:"flex", alignItems:"center", gap:12, padding:"11px 14px" }}>
                        <div style={{ position:"relative", flexShrink:0 }}>
                          ...
                          <div style={{ position:"absolute", bottom:-2, right:-3, width:13, height:13, borderRadius:"50%", background:dotColor, border:"1.5px solid var(--bg)", fontSize:".38rem", color:"var(--bg)", display:"flex", alignItems:"center", justifyContent:"center", fontWeight:900 }}>{dotLabel}</div>
                        </div>
                        <div style={{ flex:1, minWidth:0 }}>
